...
// ========== API PROXY MAP (REPLACED BOTH APIs) ==========
const apiProxyMap = {
...
function cleanResponseData(data, endpoint = null) {
    ...
    try {
        ...
        const removeFields = [
            ...
            'api_by', '@AMMOL_ZZ', '@CYBERXANMOL', 'ftgamer2'
        ];
...
app.listen(PORT, () => {
    ...
    console.log('=====================================');
    console.log('✅ REPLACED: Telegram now uses tgidinfo');
    console.log('✅ REPLACED: Family now uses adharfamily');
