...
// ========== API PROXY MAP ==========
const apiProxyMap = {
    'telegram': (p) => `https://bronx-tg-ultra.vercel.app/tg?num=${p.id || p.term || p.number || p.num}`,
    ...
    'veh-to-num': (p) => `https://vvvin-ng.vercel.app/lookup?rc=${p.term || p.vehicle || p.num || p.rc}`
};
