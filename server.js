...
const apiProxyMap = {
    ...
    'snapchat': (p) => `https://b-c-a-i.vercel.app/profile/${p.username}`, // ✅ SNAPCHAT API ADDED
...
function cleanResponseData(data, endpoint = null) {
    ...
    try {
        ...
        const removeFields = [
            ...
            'api_by', '@AMMOL_ZZ', '@CYBERXANMOL'  // Snapchat API ke developers ka credit remove
        ];
