...
// Reverse mapping: Database name → primary request endpoint
const DB_TO_ENDPOINT = {};
for (const [reqEndpoint, dbName] of Object.entries(ENDPOINT_ALIASES)) {
    if (!DB_TO_ENDPOINT[dbName]) {
        DB_TO_ENDPOINT[dbName] = reqEndpoint;
    }
}
...
app.listen(PORT, () => {
    ...
    console.log('=====================================');
    console.log('✅ FIXED: Smart endpoint matching');
    console.log('✅ FIXED: Dashboard URLs with /api/ prefix');
