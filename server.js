...
async function checkRateLimit(apiKey, keyData) {
    // If unlimited hits is enabled, skip all rate limiting
    ...
    // Increment counts for rate limiting
...
app.post('/admin/generate-key', requireAuth, (req, res) => {
    ...
    function createKey(apiKey, isCustom) {
        ...
        // If unlimited hits is true, disable rate limiting automatically
...
app.listen(PORT, () => {
    ...
    console.log('✅ All features working! No null errors!');
    console.log('✅ Unlimited hits system working!');
    console.log('=====================================\n');
});
