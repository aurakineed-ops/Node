...
// ========== MAIN API HANDLER - ALL ENDPOINTS START WITH /api/ ==========
...
app.listen(PORT, () => {
    ...
    console.log('✅ Example: /api/bgmi?key=KEY&uid=123');
    console.log('✅ Example: /api/name-details?key=KEY&name=abc');
    console.log('✅ Example: /api/telegram?key=KEY&id=123');
    console.log('=====================================');
    console.log('📚 TOTAL 26 ENDPOINTS WORKING');
