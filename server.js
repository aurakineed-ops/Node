...
db.serialize(() => {
    ...
    // API keys table with all new columns
...
// ========== MAIN API HANDLER (UPDATED WITH IP WHITELIST & TOTAL HITS) ==========
...
app.listen(PORT, () => {
    ...
    console.log('=====================================');
    console.log('✅ Features: Select All APIs, Multi-Select, Unlimited/One Time Limit');
    console.log('✅ IP Whitelist, Daily Limit, Total Hits Limit');
    console.log('=====================================\n');
});
